...
export const getCountByCenter = (token) =>{
    ...
    axios
      .get("https://mis2020.herokuapp.com/api/mis/count-by-centre-type/",axiosConfig
      )
      .then((res) => {
...
export const countByInstallationSuccess = (dataT) =>{
  ...
  export const getCountByInstallation = (token) =>{
      ...
      axios
        .get("https://mis2020.herokuapp.com/api/mis/count-by-installation-status/",axiosConfig
        )
        .then((res) => {
          console.log("RESPONSE RECEIVED: ", res);
...
export const countByQCSuccess = (dataT) =>{
  ...
  export const getCountByQC = (token) =>{
      ...
      axios
        .get("https://mis2020.herokuapp.com/api/mis/count-by-qc-status/",axiosConfig
        )
        .then((res) => {
          console.log("RESPONSE RECEIVED: ", res);
